...
[index.md](https://github.com/user-attachments/files/32494764/index.md)
---
---
...
*[Bio to add. Two or three sentences on program and focus at CU Boulder, relevant background, and main role on this project.]*
...
| Analysis and modeling: rule mining, measure selection, replenishment and sequential methods | Bhaveeash | Raghavendra |
| Visualization | Raghavendra | Bhaveeash |
| Documentation and website | Shared | Shared |
| Reproducibility: repo structure, environment | Bhaveeash | Raghavendra |
...
Confirm the exact year, venue, and title for each source against the original before final submission, and use one consistent citation style.

## Repository

Code, data instructions, and this site live in the project repository. *[Add the GitHub repository URL.]*
